...
export class MessageManagerProvider extends Component {
  state = {
    showMessage: false,
    message: "",
    messages: [],
  ...
  getNewState = (type, options) => {
    ...
    if (iconClass) {
      ...
      const defaultClass = isError ? configs.defaultErrorIconClass || '' :
        configs.defaultSuccessIconClass || '';
 ...
 */
export const injectMessageManager = (WrappedComponent) => {
